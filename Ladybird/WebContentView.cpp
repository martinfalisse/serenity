...
WebContentView::WebContentView(StringView webdriver_content_ipc_path, WebView::EnableCallgrindProfiling enable_callgrind_profiling, WebView::IsLayoutTestMode is_layout_test_mode)
    : m_webdriver_content_ipc_path(webdriver_content_ipc_path)
{
    ...
    create_client(enable_callgrind_profiling, is_layout_test_mode);
}
...
void WebContentView::create_client(WebView::EnableCallgrindProfiling enable_callgrind_profiling, WebView::IsLayoutTestMode is_layout_test_mode)
{
    m_client_state = {};

    auto candidate_web_content_paths = get_paths_for_helper_process("WebContent"sv).release_value_but_fixme_should_propagate_errors();
    auto new_client = launch_web_content_process(candidate_web_content_paths, enable_callgrind_profiling, is_layout_test_mode).release_value_but_fixme_should_propagate_errors();
