...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    args_parser.add_option(is_layout_test_mode, "Is layout test mode", "layout-test-mode", 'c', "is_layout_test_mode");
    args_parser.parse(arguments);

    VERIFY(webcontent_fd_passing_socket >= 0);

    Web::Platform::FontPlugin::install(*new Ladybird::FontPluginQt(is_layout_test_mode > -1));
